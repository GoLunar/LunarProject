    ...
    public static void buildData() throws SQLException{
        ...
        try{
          ...
          for (int i = 0; i < data.size(); i++){
                list.getItems().add((String)data.get(i).get(1));
           }
          ...
          try{
                ...
                String query = "select * from classesadded where student = ?";
          ...
          gradeb.setOnAction(e ->{
            try{
                String query = "update classesadded set crn=?, student=?, grade=? where student='"+student.getText()+"' ";
                prepstate = connect.prepareStatement(query);
                prepstate.setString(1, crn.getText());
                prepstate.setString(2, student.getText());
                prepstate.setString(3, grade.getText());
