...
public class viewGrade {
	...
	try {
		...
		String Signupstring = "SELECT Distinct classinfo.crn,course,credits,name,time,professor,length,room,grade FROM classesadded inner join classinfo on classesadded.crn = classinfo.crn where classesadded.student=?";
